...
lyr__1.set('fieldLabels', {'국민의숲 일련번호': 'hidden field', '국민의숲 유형내용': 'no label', '국민의숲 관리소명': 'inline label - visible with data', '국민의숲 주소': 'inline label - visible with data', 'Latitude': 'hidden field', 'Longitude': 'hidden field', '국민의숲 전화번호': 'inline label - visible with data', '국민의숲 관리기관명': 'no label', '최초작성일시': 'hidden field', '최종수정일시': 'hidden field', });
